...
export const STR = {
  ...
  'admins.title': { ru: 'Администраторы', en: 'Admins' },
  'admins.add': { ru: 'Добавить', en: 'Add' },
  'admins.you': { ru: 'это ты', en: 'you' },
  'admins.noPlayer': { ru: 'нет карточки игрока', en: 'no player card' },
  'admins.roleFull': { ru: 'Полные', en: 'Full' },
  'admins.roleHost': { ru: 'Ведущий', en: 'Host' },
  'admins.remove': { ru: 'Снять права', en: 'Remove' },
  'admins.removeConfirm': { ru: 'Снять права администратора с {name}?',
                            en: 'Remove admin rights from {name}?' },
  'admins.toggleHint': { ru: 'Нажми, чтобы сменить роль', en: 'Tap to switch role' },
  'admins.selfLock': { ru: 'Свою роль менять нельзя', en: "You can't change your own role" },
  'admins.searchPh': { ru: 'Поиск по имени', en: 'Search by name' },
  'admins.onlyLinked': { ru: 'Только привязанные к Telegram', en: 'Telegram-linked players only' },
  'admins.noCandidates': { ru: 'Некого добавить — сначала пришли игроку приглашение, чтобы он привязал Telegram.',
                           en: 'Nobody to add — send an invite first so they link Telegram.' },
  'admins.explain': { ru: 'Ведущий проводит турниры и может завести игрока. Полные права дополнительно дают заявки, уровни, приглашения и удаление игроков.',
                      en: 'A host runs tournaments and can add a player. Full rights also cover join requests, levels, invites and deleting players.' },
  'social.title': { ru: 'Профиль', en: 'Profile' },
  'social.empty': { ru: 'Расскажи о себе — где работаешь и чем занимаешься.',
                    en: 'Tell others where you work and what you do.' },
  'social.add': { ru: 'Заполнить', en: 'Add' },
  'social.edit': { ru: 'Изменить', en: 'Edit' },
  'social.company': { ru: 'Компания', en: 'Company' },
  'social.companyPh': { ru: 'Например, First Crypto Exchange', en: 'e.g. First Crypto Exchange' },
  'social.position': { ru: 'Должность', en: 'Position' },
  'social.about': { ru: 'О себе', en: 'About you' },
  'social.aboutPh': { ru: 'Чем занимаешься и чем можешь быть полезен сообществу — пара предложений.',
                      en: 'What you do and how you can be useful to the community — a couple of sentences.' },
  'social.positionPh': { ru: 'Например, Head of Trading', en: 'e.g. Head of Trading' },
